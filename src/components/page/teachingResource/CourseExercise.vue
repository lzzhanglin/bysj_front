    ...
    <div>
        ...
        <div class="container" >
            <div class="form-box">
                ...
                <el-form ref="courseWareForm" :model="courseWareForm"  :rules="rules" label-width="120px" >
                    ...
                    <el-form-item label="课程习题上传" v-if="role==='ROLE_TEACHER'">
                        <el-upload
                            class="upload-demo"
                            ref="upload"
                            :limit="1"
                            ...
                            <div slot="tip" class="el-upload__tip" style="color:#3a8ee6;">选择课程和章节之后方可进行上传，预览课程习题，只能上传 word 文档</div>
                        </el-upload>
