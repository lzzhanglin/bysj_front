    ...
    routes: [
        ...
        },
        {
            ...
            children:[
                ...
                {
                    path: 'talent',
                    component: resolve => require(['../components/page/teachingAchievement/ShowTalentAchievement.vue'], resolve),
                    meta: { title: '人才培养成果',requireAuth:true,requireTeacher:true }
                },
                {
                    path: 'award',
                    component: resolve => require(['../components/page/teachingAchievement/ShowGetAward.vue'], resolve),
                    meta: { title: '获得奖项',requireAuth:true,requireTeacher:true }
                } ,
                {
                    path: 'achievement',
                    component: resolve => require(['../components/page/teachingAchievement/ShowTeachingAchievement.vue'], resolve),
                    meta: { title: '教学成果',requireAuth:true,requireTeacher:true }
                }
