    ...
    routes: [
        ...
        },
        {
            ...
            children:[
                {
                    path: 'create',
                    component: resolve => require(['../components/page/CreateExperiment.vue'], resolve),
                    meta: { title: '新建实验',requireAuth:true,requireTeacher:true }
                },
                {
                    path: 'manage',
                    component: resolve => require(['../components/page/ManageExperiment.vue'], resolve),
                    meta: { title: '管理实验',requireAuth:true,requireTeacher:true }
                },
            ]
        },
        {
