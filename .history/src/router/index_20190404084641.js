            ...
            children:[
                {
                    path: 'create',
                    component: resolve => require(['../components/page/CreateCourse.vue'], resolve),
                    meta: { title: '创建课程',requireAuth:true,isTeacher:true }
                },
                {
                    path: 'manage',
                    component: resolve => require(['../components/page/ManageCourse.vue'], resolve),
                    meta: { title: '管理课程',requireAuth:true,isTeacher:true }
                },
                {
                    path: 'choose',
                    component: resolve => require(['../components/page/ChooseCourse.vue'], resolve),
                    meta: { title: '选课中心',requireAuth:true}
                }
            ]
        },
        {
            ...
            children:[
                {
                    path: '/dashboard',
                    component: resolve => require(['../components/page/Dashboard.vue'], resolve),
                    meta: { title: '系统首页',requireAuth:true,isTeacher:true }
                },
