<template>
    <div>
        ...
        <div class="container">
            <div class="form-box">
                <el-form ref="courseForm" :model="form"  :rules="rules" label-width="80px">
                    ...
                    <el-form-item label="开课日期" prop="dateBegin">
                        <el-col :span="11">
                            <el-date-picker type="date" placeholder="选择开课日期"  :picker-options="dateBegin"  v-model="courseForm.dateBegin" style="width: 100%;"></el-date-picker>
                        </el-col>
                       
                    </el-form-item>
                    <el-form-item label="结课日期" prop="dateEnd">
                        <el-col :span="11">
                            <el-date-picker type="date" placeholder="选择结课日期"  :picker-options="dateEnd" v-model="courseForm.dateEnd" style="width: 100%;"></el-date-picker>
                        </el-col>
