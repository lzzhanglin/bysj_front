    ...
    <div>
        <div class="crumbs" v-if="role==='ROLE_TEACHER'">
            <el-breadcrumb separator="/">
                ...
                <el-breadcrumb-item> 创建课程规划</el-breadcrumb-item>
            </el-breadcrumb>
        </div>
        <div class="container" v-if="role==='ROLE_TEACHER'">
            <div class="form-box">
                <el-form ref="courseInfoForm" :model="courseInfoForm"  :rules="rules" label-width="80px">
                    <el-form-item label="课程名称" prop="infoName">
                        <el-input v-model="courseInfoForm.infoName"></el-input>
                    </el-form-item>
                     <el-form-item label="课程规划" prop="infoDetail">
       ...
       <div class="crumbs">
            <el-breadcrumb separator="/">
                <el-breadcrumb-item><i class="el-icon-lx-calendar"></i> 课程建设</el-breadcrumb-item>
                <el-breadcrumb-item> 课程规划</el-breadcrumb-item>
            </el-breadcrumb>
        </div>
        ...
        <div class="container">
            <div slot="tip" v-if="isEmpty" style="color:red;font-size:18px;text-align:center;">暂无规划</div>
   
                <div v-for="info in infoList" :key='info.courseInfoId'>
                   <div class="plugins-tips"  style="width:100%;margin-top:0px;">
                        <p align="center">{{info.infoName}}</p>
                    </div>
                        <div class="plugins-tips"  style="width:100%;margin-top:0px;">
                        <p align="center" style="margin-left:30px;margin-right:30px; line-height:300%">{{info.infoDetail}}</p>
                    </div>
                    <!-- <span style="margin-left:770px;">上传时间：{{condition.uploadTime}}</span> -->
                    <el-row>
                        <el-button style="margin-top:10px; margin-bottom:30px;" size="small" type="danger" @click="handleDelete(info.courseInfoId)" v-if="role==='ROLE_TEACHER'" >删 除</el-button>
                    </el-row>
