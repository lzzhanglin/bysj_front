<template>
    <div>
                ...
                <el-form ref="conditionForm" :model="conditionForm"  :rules="rules" label-width="100px">
                    ...
                    <el-form-item label="课程大纲上传">
                        <el-upload
                            ...
                            <div slot="tip" class="el-upload__tip" style="color:#3a8ee6;">只能上传word文档</div>
                        </el-upload>
       ...
       <div class="crumbs">
            <el-breadcrumb separator="/">
                <el-breadcrumb-item><i class="el-icon-lx-calendar"></i> 课程建设</el-breadcrumb-item>
                <el-breadcrumb-item> 课程大纲预览</el-breadcrumb-item>
            </el-breadcrumb>
        </div>
        ...
        <div class="container">
            <div slot="tip" v-if="isEmpty" style="color:red;font-size:18px;text-align:center;">暂无大纲</div>
                ...
                <div v-for="condition in conditions" :key='condition.practicalConditionId'>
                   <div class="plugins-tips"  style="width:100%;margin-top:0px;">
                    ...
                    <el-row>
                        <el-button style="margin-top:10px; margin-bottom:10px;" size="small" type="primary" @click="handleDownload(condition.externalLink)" >下 载</el-button>
                        <el-button style="margin-top:10px; margin-bottom:10px;" size="small" type="danger" @click="handleDelete(condition.practicalConditionId)" v-if="role==='ROLE_TEACHER'" >删 除</el-button>
                    </el-row>
         ...
         onSuccess(response,file) {
            ...
            //在线预览的链接 加上微软的链接
             var previewLink = "https://view.officeapps.live.com/op/embed.aspx?src="+this.externalLink;
                ...
                //上传七牛云成功之后 将上传文档的信息写入数据库 这里课程大纲和实践教学共用数据库中的practical_conditon表 filetype为4
