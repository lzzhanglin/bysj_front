                ...
                <el-form ref="courseInfoForm" :model="courseInfoForm"  :rules="rules" label-width="120px">
                    <el-form-item label="课程名称" prop="infoName">
                     ...
                     <el-form-item label="课程介绍" prop="infoDetail">
                        <el-input type="text" rows="5" v-model="courseInfoForm.infoDetail"></el-input>
                    </el-form-item>
                   <el-form-item>
                        <el-button type="primary" @click="onSubmit('courseForm')">保 存</el-button>
            ...
            //在线预览的链接 加上微软的链接
             var previewLink = "https://view.officeapps.live.com/op/embed.aspx?src="+this.externalLink;
                ...
                this.postRequest('/api/practicalCondition/writeFileInfo', {
                            ...
                            fileType: 3,
                            describe: this.courseInfoForm.describe
                  }).then(resp=> {
