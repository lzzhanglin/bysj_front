       ...
       <div class="crumbs">
        ...
        <div class="container">
                ...
                <div v-for="info in infoList" :key='info.courseInfoId'>
                   <div class="plugins-tips"  style="width:40%;margin-top:0px;">
                        <p align="center">课程名称：{{info.infoName}}</p>
                    </div>
                        <div class="plugins-tips"  style="width:80%;margin-top:0px;">
                        <p align="center" style="line-height:300%">{{info.infoDetail}}</p>
                    </div>
