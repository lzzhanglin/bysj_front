                    ...
                    <el-form-item>
                     ...
                     <el-form-item label="课件上传">
                        <el-upload
                            ...
                            :file-list="fileList"
                            :auto-upload="false">
                            <el-button slot="trigger"  style="" size="small" type="primary">选取文件</el-button>
                             <el-button style="margin-left: 20px; float:top" size="small" type="success">选中文件哈哈哈</el-button>
                            
                            <el-button style="margin-left: 20px; float:top" size="small" type="success" @click="submitUpload">上传到服务器</el-button>
