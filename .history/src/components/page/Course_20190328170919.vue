...
<script>
    export default {
        ...
        data: function(){
            ...
            return {
                ...
                disabledDate: (time) => {
                    if (this.form.dateEnd) {
                        console.log(new Date(this.form.dateEnd).getTime());
                        return time.getTime() >  new Date(this.form.dateEnd).getTime();
            ...
            dateEnd: {
                disabledDate: (time) => {
                    return time.getTime() < new Date(this.form.dateBegin).getTime()+8.64e7;//减去一天的时间代表可以选择同一天;
                }
            },
