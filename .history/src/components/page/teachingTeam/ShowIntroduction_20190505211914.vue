    ...
    <div class="table">
        ...
        <div class="container">
            ...
            <el-table :data="tableData" border class="table" ref="multipleTable" >
                ...
                <el-table-column prop="birthDay" label="出生年月" align="center" sortable width="150">
                </el-table-column>
                ...
                <el-table-column prop="position" label="担任职务" align="center" sortable width="200">
                </el-table-column>
         ...
         <el-dialog title="编辑" :visible.sync="editVisible" width="50%">
            <el-form ref="form" :model="form" label-width="100px">
                 ...
                 <el-form-item label="性别">
                    ...
                    <el-date-picker type="month" placeholder="选择日期" :picker-options="dateBeginOptions" :disabled="isView"
                    v-model="form.birthDay" value-format="yyyy-MM" ></el-date-picker>
                </el-form-item>
                 ...
                 <el-form-item label="职称" prop="jobTitle" >
                    ...
                    <el-input type="textarea" rows="10" v-model="form.introduction" :disabled="isView"></el-input>
                    </el-form-item>
