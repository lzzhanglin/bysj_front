         ...
         <el-dialog title="编辑" :visible.sync="editVisible" width="30%">
            <el-form ref="form" :model="form" label-width="50px">
                 <el-form-item label="教师">
                    <el-input v-model="form.teacherName" disabled="this.isView"></el-input>
                </el-form-item>

                 <el-form-item label="性别">
                        <el-select v-model="form.sex" disabled="this.isView" >
                            <el-option key="male" label="男" value="男"></el-option>
                            <el-option key="female" label="女" value="女"></el-option>
                        </el-select>
                    </el-form-item>
                 <el-form-item label="学历" prop="education" >
                        <el-select v-model="form.education" placeholder="请选择" disabled="this.isView">
                 ...
                 <el-form-item label="职称" prop="jobTitle" >
                        <el-select v-model="form.jobTitle" placeholder="请选择" disabled="this.isView">
                     ...
                     <el-form-item label="所属学院" prop="affiliatedCollege">
                        <el-select v-model="form.affiliatedCollege" placeholder="请选择" disabled="this.isView">
                    ...
                    <el-input v-model="form.introduction" disabled="this.isView"></el-input>
                    </el-form-item>
