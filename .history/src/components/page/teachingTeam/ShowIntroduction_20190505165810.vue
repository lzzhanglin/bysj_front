            ...
            <el-table :data="tableData" border class="table" ref="multipleTable" >
                ...
                <template slot-scope="scope"> 
                    <el-button type="text" icon="el-icon-lx-attention" class="green" @click="handleView(scope.$index, scope.row)">查看详情</el-button>
                         <el-button type="text" icon="el-icon-edit" @click="handleEdit(scope.$index, scope.row)" v-if="window.localStorage['role']==='TEACHER'">编辑</el-button> 
                         <el-button type="text" icon="el-icon-delete" class="red" @click="handleDelete(scope.$index, scope.row)" v-if="window.localStorage['role']==='TEACHER'">删除</el-button> 
                     </template>
                 </el-table-column>
            </el-table>
