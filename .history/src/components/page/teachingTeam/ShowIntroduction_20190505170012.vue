    ...
    <div class="table">
        ...
        <div class="container">
            ...
            <el-table :data="tableData" border class="table" ref="multipleTable" >
                ...
                <el-table-column prop="sex" label="性别" align="center" sortable width="200">
                </el-table-column>
                <el-table-column prop="education" label="学历" align="center" sortable width="100">
                </el-table-column>
                <el-table-column prop="jobTitle" label="职称" align="center" sortable width="250">
                </el-table-column>
                <el-table-column prop="affiliatedCollege" label="所属学院" align="center" sortable width="150">
                </el-table-column>
                ...
                <template slot-scope="scope"> 
                    <el-button type="text" icon="el-icon-lx-attention" class="green" @click="handleView(scope.$index, scope.row)">查看详情</el-button>
                         <el-button type="text" icon="el-icon-edit" @click="handleEdit(scope.$index, scope.row)" v-if="window.localStorage['role']==='ROLE_TEACHER'">编辑</el-button> 
                         <el-button type="text" icon="el-icon-delete" class="red" @click="handleDelete(scope.$index, scope.row)" v-if="window.localStorage['role']==='ROLE_TEACHER'">删除</el-button> 
                     </template>
                 </el-table-column>
            </el-table>
            ...
            <el-form ref="form" :model="form" label-width="50px">
                 ...
                 <el-form-item label="职称" prop="jobTitle">
                     ...
                     <el-form-item label="所属学院" prop="affiliatedCollege">
                        <el-select v-model="form.affiliatedCollege" placeholder="请选择">
