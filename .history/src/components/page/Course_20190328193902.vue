                ...
                <el-form ref="courseForm" :model="courseForm"  :rules="rules" label-width="80px">
                    ...
                    <el-form-item label="开课日期" prop="dateBegin">
                        <el-col :span="11">
                            ...
                            @change="formatTime" format="yyyy-MM-dd"  v-model="courseForm.dateBegin" style="width: 100%;"></el-date-picker>
                        </el-col>
                    ...
                    <el-form-item label="结课日期" prop="dateEnd">
                        <el-col :span="11">
                            ...
                            @change="formatTime" format="yyyy-MM-dd" v-model="courseForm.dateEnd" style="width: 100%;"></el-date-picker>
                        </el-col>
