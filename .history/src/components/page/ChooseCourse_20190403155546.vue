    ...
    <div class="table">
        <div class="crumbs">
            ...
            <el-breadcrumb-item><i class="el-icon-lx-calendar"></i> 课程</el-breadcrumb-item>
                <el-breadcrumb-item><i class="el-icon-lx-cascades"></i> 选课中心</el-breadcrumb-item>
            </el-breadcrumb>
        </div>
        <div class="container">
            ...
            <el-table :data="tableData" border class="table" ref="multipleTable" >
                ...
                <el-table-column prop="courseIntro" label="课程简介" sortable width="150">
                </el-table-column>
                ...
                <el-table-column prop="electorNum" label="选课人数" >
                </el-table-column>
            ...
            getData() {
              ...
              let _this = this
                this.$axios.get('/api/course/getCourseList', {
                    ...
                    console.log("循环外面,长度为："+ res.data.data.length);
                ...
                console.log("课程名称为："+obj.courseName);
                dataFromDb[i] = obj
            }
