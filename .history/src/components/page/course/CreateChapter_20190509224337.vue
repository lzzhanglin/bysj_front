                ...
                this.$refs[formName].validate((valid) => {
                    if(valid){
                         this.postRequest('/api/course/create', {
                            courseName: this.chapterForm.name,
                            courseKind: this.chapterForm.kind,
                            timeBegin: this.$moment(this.chapterForm.dateBegin).format('YYYY-MM-DD HH:mm:ss'),
                            timeEnd: this.$moment(this.chapterForm.dateEnd).format('YYYY-MM-DD HH:mm:ss'),
                            courseIntro: this.chapterForm.intro
                  }).then(resp=> {
