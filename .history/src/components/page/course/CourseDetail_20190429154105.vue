       ...
       <div class="form-box">
                <el-form ref="detailForm" :model="detailForm"  :rules="rules" label-width="80px" >
                    ...
                    <el-form-item>
                        ...
                        <el-button type="success" @click="reSetContent('detailForm')">清空表单</el-button>
                    </el-form-item>
                     ...
                     <el-form-item label="课件上传">
                        <el-upload
                            ...
                            <div slot="tip" class="el-upload__tip" style="color:red;">注意：请先保存章节再上传课件 当前章节所有课件上传完毕后清空表单 </div>
                        </el-upload>
