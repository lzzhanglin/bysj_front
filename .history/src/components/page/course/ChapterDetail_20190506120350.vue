     ...
     <p v-html="chapterContent"></p>
       ...
       <div class="crumbs">
        ...
        <template slot-scope="scope">
          <a :href="'http://127.0.0.1:8081/courseWare/download?courseWareName='+scope.row.courseWareName" download="w3logo"
            target="_blank"
             style="color:red;">{{scope.row.courseWareName}}</a>
        </template>
      </el-table-column>
...
export default {
    ...
    methods:{
        handleDownload(index, row){
            console.log("进入下载");
            window.open('http://127.0.0.1:8081/courseWare/download?courseWareName='+item.courseWareName);
