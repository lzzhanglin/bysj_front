<template>
    <div>
        ...
        <div class="container" style="padding-top:0px;" v-if="isChoose" >
              <div slot="tip" v-if="isEmpty" style="color:red;font-size:18px;text-align:center;">该章节暂无课件</div>
       
   
                <div v-for="solution in solutionList" :key='solution.solutionId'>
                  
                   <div class="plugins-tips"  style="margin-top:40px;margin-right:4px;">
                        <p align="center">{{solution.solutionName}}</p>
                    </div>
         ...
         onSuccess(response,file) {
            ...
            chooseCourse(){
             ...
             chooseExercise(){
                 ...
                 console.log("参数为："+this.solutionForm.exerciseId);
                  this.getExerciseList();
                  this.isChoose = true;
                  //获取当前选择的课程名 章节名
                ...
                this.$axios.get('/api/solution/getSolutionList', {
                    ...
                    if(res.data.data != null){
                         for (let i = 0; i < res.data.data.length; i++) {
                            ...
                            obj.exerciseName = dt[i].exerciseName
                            dataFromDb[i] = obj
            }
