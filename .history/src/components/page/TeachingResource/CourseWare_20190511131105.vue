<template>
                ...
                <el-form ref="courseWareForm" :model="courseWareForm"  :rules="rules" label-width="80px" >
                    ...
                    <el-col :span="12">
                     <el-form-item label="所属章节" prop="chapterId">
                        <el-select v-model="courseWareForm.chapterId" :disabled="disableChapter" placeholder="请先选择课程">
                           <el-option
   ...
   <!-- <div class="crumbs" v-if="role==='ROLE_TEACHER'">
            <el-breadcrumb separator="/">
                <el-breadcrumb-item><i class="el-icon-lx-calendar"></i> 教学资源</el-breadcrumb-item>
                <el-breadcrumb-item> 课件上传</el-breadcrumb-item>
            </el-breadcrumb>
        </div>
        <div class="container" v-if="role==='ROLE_TEACHER'"> -->
            <!-- <div class="form-box">
                <el-form ref="resourceForm" :model="resourceForm"  :rules="rules" label-width="80px">
                    <el-form-item label="课件名称" prop="courseWareName">
                        <el-input v-model="resourceForm.courseWareName"></el-input>
                    </el-form-item> -->
