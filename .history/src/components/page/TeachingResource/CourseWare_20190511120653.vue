            ...
            <div class="form-box">
                ...
                <el-form ref="courseWareForm" :model="courseWareForm"  :rules="rules" label-width="80px" >
                    ...
                    <el-form-item label="所属课程" prop="courseId">
                        <el-select v-model="courseWareForm.courseId"  @click.native="chooseCourse" placeholder="请选择">
                           <el-option
                    ...
                    <el-col :span="12">
                     <el-form-item label="所属章节" prop="chapterId">
                        <el-select v-model="courseWareForm.courseId" :disabled="disableChapter" placeholder="请选择">
                           <el-option
        ...
        methods: {
            chooseCourse(){
             ...
             getChapterList() {
                var dataFromDb = [];
              let _this = this
                this.$axios.get('/api/chapter/getCourseList', {
                    params:{
