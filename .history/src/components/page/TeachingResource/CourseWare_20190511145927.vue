    ...
    <div>
        ...
        <div class="container" >
            <div class="form-box">
                ...
                <el-form ref="courseWareForm" :model="courseWareForm"  :rules="rules" label-width="80px" >
                    ...
                    <el-form-item label="课件上传" v-if="role==='ROLE_TEACHER'">
                        <el-upload
                            ...
                            <div slot="tip" class="el-upload__tip" style="color:red;">请选择课程和章节之后再上传课件，只能上传 PPT 文档</div>
                        </el-upload>
                ...
                <div slot="tip" v-if="role==='ROLE_STUDENT'" style="color:#4fc8db;font-size:12px;margin-left:80px;">Tip: 选择课程和章节之后方可预览课件</div>
            </div>
        </div>
             <div class="crumbs">
                    <el-breadcrumb separator="/">
