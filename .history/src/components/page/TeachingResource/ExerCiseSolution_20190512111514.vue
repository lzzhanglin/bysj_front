    ...
    export default{ 
        ...
        methods: {
         ...
         onSuccess(response,file) {
            ...
            chooseCourse(){
            console.log("id为："+this.solutionForm.exerciseId);
            ...
            this.getExerciseList();
                 ...
                 console.log("作业id为："+this.solutionForm.exerciseId);
                 console.log("课程id为："+this.solutionForm.courseId);
                  this.getSolutionList();
                  this.isChoose = true;
                  //获取当前选择的课程名 章节名
                ...
                //   }
                //    for(let i = 0;i < this.exercises.length;i++){
                //       if (this.exercises[i].chapterId == this.solutionForm.chapterId){
