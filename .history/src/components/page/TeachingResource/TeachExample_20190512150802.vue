    ...
    <div>
        ...
        <div class="container" style="padding-top:0px;" v-if="isChoose" >
              <div slot="tip" v-if="isEmpty" style="color:red;font-size:18px;text-align:center;margin-top:30px;">该课程暂无教学案例</div>
                ...
                <div v-for="solution in exampleList" :key='solution.solutionId'>
    ...
    export default{ 
        ...
        methods: {
         ...
         onSuccess(response,file) {
            ...
            chooseCourse(){
                if(this.exampleForm.exerciseId != null){
                this.exampleForm.exerciseId = null;
                }
             ...
             getTeachExampleList() {
              ...
              let _this = this
                this.$axios.get('/api/solution/getTeachExampleList', {
                    params:{
                        exerciseId:this.exampleForm.exerciseId
                    }
                }).then((res) => {
             ...
             handleDelete(solutionId) {
                ...
                this.deleteExampleId = solutionId;
            },
     
            deleteExample(solutionId){
                  this.$axios.delete('/api/solution/delete', {
                    params: {
                        solutionId: this.deleteExampleId
                    }
                }).then((res) => {
