    ...
    <div>
        ...
        <div class="container" >
            <div class="form-box">
                ...
                <el-form ref="courseWareForm" :model="courseWareForm"  :rules="rules" label-width="500px" >
                    <el-form-item label="请选择课程及章节之后再进行课件操作" >
                    ...
                    <el-form-item label="课件上传" v-if="role==='ROLE_TEACHER'">
                        <el-upload
                            ...
                            <div slot="tip" class="el-upload__tip" style="color:red;">只能上传 PPT 文档</div>
                        </el-upload>
