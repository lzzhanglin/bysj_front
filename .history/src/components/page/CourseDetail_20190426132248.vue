       ...
       <div class="form-box">
                <el-form ref="courseForm" :model="detailForm"  :rules="rules" label-width="80px">
                    <el-form-item label="章节名称" prop="name">
                        <el-input v-model="detailForm.chapterName"></el-input>
                    </el-form-item>
                    <el-form-item label="章节序号" prop="name" placeholder="请填入数字来标识章节顺序">
                        <el-input v-model="detailForm.chapterOrder"></el-input>
                    </el-form-item>
                  
                   
                    <el-form-item label="章节内容" prop="intro">
                        <el-input type="textarea" rows="5" v-model="detailForm.chapterContent"></el-input>
                    </el-form-item>
                    <el-form-item>
