       ...
       <div class="form-box">
                <el-form ref="detailForm" :model="detailForm"  :rules="rules" label-width="80px" >
                    ...
                    <el-form-item label="章节内容" prop="chapterContent">
                        <quill-editor ref="myQuillEditor" v-model="detailForm.chapterContent" :options="editorOption" style="width:1100px;"></quill-editor>
                    ...
                    <el-form-item>
                     ...
                     <el-form-item label="课件上传">
                        <el-upload
                            ...
                            :file-list="fileList"
                            :auto-upload="false">
                            <el-button slot="trigger"  style="float:left;" size="small" type="primary">选取文件</el-button>
                             <el-button style=" visibility: hidden;" size="small" type="success">选中文件哈哈哈</el-button>
                            
                            <el-button style="margin-left: 20px;float:left" size="small" type="success" @click="submitUpload">上传到服务器</el-button>
                ...
                <div class="el-upload__tip" slot="tip" style="color:red;">注意：请先保存章节再上传课件 一个章节最多上传3个课件</div>
            </el-upload> -->
                    </el-form-item>
                </el-form>
