    ...
    <div>
       ...
       <div class="crumbs">
        ...
        <div class="container">
               ...
               <img :src="'http://127.0.0.1:8080/api/practicalCondition/show?imgName=' +condition.practicalConditionName" style="width:800px;border:4px;">图片测试<img>
               <span>{{condition.practicalConditionName}}</span>
               <span>{{condition.describe}}</span>
                </div>
        </div>
