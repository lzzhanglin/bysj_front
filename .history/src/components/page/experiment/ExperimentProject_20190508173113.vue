        ...
        <div class="container">
                ...
                <div v-for="condition in conditions" :key='condition.practicalConditionId'>
                   <div class="plugins-tips"  style="width:100%;margin-top:0px;">
                    ...
                    <el-row>
                        <el-button style="margin-top:10px; float:right;" size="small" type="primary" @click="handleDelete(condition.practicalConditionId)" v-if="role==='ROLE_TEACHER'" >下 载</el-button>
                        <el-button style="margin-top:10px;float:right;" size="small" type="danger" @click="handleDelete(condition.practicalConditionId)" v-if="role==='ROLE_TEACHER'" >删 除</el-button>
                    </el-row>
