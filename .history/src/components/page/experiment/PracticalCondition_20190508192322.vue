    ...
    <div>
       ...
       <div class="crumbs">
        ...
        <div class="container">
               ...
               <div class="img_wrap">
                   <img :src="'http://127.0.0.1:8080/api/practicalCondition/showImg?imgName=' +condition.practicalConditionName" style="width:1000px; text-align:center"><img>
               </div>
