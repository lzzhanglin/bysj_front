<template>
    <div>
       ...
       <div class="crumbs">
        ...
        ?src=http://pqnfa0l6o.bkt.clouddn.com/%E6%B8%85%E5%8D%95%E8%AF%B4%E6%98%8E-vj0NBZAIYO.docx'
        ...
        <div class="container">
             <iframe src='https://view.officeapps.live.com/op/embed.aspx?src=http://pqnfa0l6o.bkt.clouddn.com/%E6%B8%85%E5%8D%95%E8%AF%B4%E6%98%8E-vj0NBZAIYO.docx' width='100%' height='800px' frameborder='0'>
    ...
    export default {
        ...
        methods: {
         ...
         onSuccess(response,file) {
             //外链 一个月变一次 应绑定自己的域名
             this.externalLink = `http://pqnfa0l6o.bkt.clouddn.com/${response.key}`
