...
<iframe src="{{condition.practicalConditionName}}" frameborder="0">
</iframe>
                   <!-- <iframe :src="https://docs.google.com/gview?url=/http://127.0.0.1:8080/api/practicalCondition/showWord/wordName=/"{{condition.practicalConditionName}} frameborder="0">
                   </iframe> -->
