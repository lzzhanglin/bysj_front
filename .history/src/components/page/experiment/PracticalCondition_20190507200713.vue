       ...
       <div class="crumbs">
        ...
        <div class="container">
                <div v-for="condition in conditions" :key='condition.practicalConditionId'>
                        <div>{{condition.practicalConditionName}}</div>
                        <br>
               <div style="text-align:center">{{condition.describe}}</div>
               <br>
               <img :src="'http://127.0.0.1:8080/api/practicalCondition/show?imgName=' +condition.practicalConditionName" style="width:800px;"><img>
           <br>
                </div>
        </div>
