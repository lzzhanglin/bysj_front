       ...
       <div class="form-box">
                <el-form ref="detailForm" :model="detailForm"  :rules="rules" label-width="80px" >
                    ...
                    <el-form-item label="章节内容" prop="chapterContent">
                        <quill-editor ref="myQuillEditor" v-model="detailForm.chapterContent" :options="editorOption" style="width:1000px;"></quill-editor>
                       
                    </el-form-item>
                       <!-- 文件上传input 将它隐藏-->
                        <el-upload 
                        class="upload-demo" 
                        action="http://pqnfa0l6o.bkt.clouddn.com/"
...
const STATVIDEO = 'http://pqnfa0l6o.bkt.clouddn.com/'
    ...
    export default {
       ...
       return params
        ...
        get qnLocation() {
          console.log(location.protocol === 'http:' ? 'http://upload.qiniu.com' : 'https://up.qbox.me');
