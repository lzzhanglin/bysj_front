                     ...
                     <el-form-item label="课件上传">
                        <el-upload
                            ...
                            <el-button slot="trigger"  style="float:left" size="small" type="primary">选取文件</el-button>
                             <el-button style=" visibility: hidden;float:left" size="small" type="success">选中文件哈哈哈</el-button>
                            
                            <el-button style="margin-left: 20px;" size="small" type="success" @click="submitUpload">上传到服务器</el-button>
