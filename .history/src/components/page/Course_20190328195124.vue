        ...
        <div class="container">
            <div class="form-box">
                <el-form ref="courseForm" :model="courseForm"  :rules="rules" label-width="80px">
                    ...
                    <el-form-item label="开课及结课日期" prop="dateBegin" label-width="80px">
                        <el-date-picker v-model="timeBeginAndEnd" type="daterange" align="right" unlink-panels range-separator="至" 
