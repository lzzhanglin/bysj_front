            ...
            <div class="form-box">
                <el-form ref="achievementForm" :model="achievementForm"  :rules="rules" label-width="80px">
                    ...
                    <el-form-item>
                        ...
                        <el-button type="danger" @click="reSetContent('detailForm')">清空表单</el-button>
                    </el-form-item>
                    <el-form-item label="资料上传">
                        <el-upload
                            ...
                            <el-button style="float:left" size="small" type="primary" @click="submitUpload" :disabled="disableUpload">上传到服务器</el-button>
                    </el-form-item>
